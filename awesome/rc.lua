home = "/home/gabriel/" --your home directory
configpath = "/home/gabriel/.config/awesome/" --path to this awesome configuration (usually ~/.config/awesome)
--configpath = "./"
...
pathToOpenmap = "/home/gabriel/openmapkey" -- path to a file with an openweathermap key
open_map_key = "1f6cccaae108007c0df4697cccc2bdf7" -- or copy your openweathermap key into this string variale
city = "Mendoza,AR" -- enter your city + country for the weather information (check: https://openweathermap.org/current)
terminal = "urxvt"
redshiftconfig = "/home/gabriel/.config/redshift.conf" -- configuration file for Redshift
...
awful.key({ }, "XF86AudioLowerVolume", function () awful.spawn("pactl set-sink-volume 0 -10%") end, {description = "decrease volume", group = "custom"}),
awful.key({ }, "XF86AudioRaiseVolume", function () awful.spawn("pactl set-sink-volume 0 +10%") end, {description = "increase volume", group = "custom"}),
